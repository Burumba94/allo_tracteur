...
DirectPay.prototype.creditAccount = function (account, amount, callback){
  var self = this;
  var body = {
  ...
  request.post({
    ...
    if (body && body.response_code === '00') {
      ...
      callback(null, self);
    } else callback(new Error(util.format('Failed to credit %s. Please ensure %s and %s are valid OR check your account balance.', account, amount)));
  });
};
